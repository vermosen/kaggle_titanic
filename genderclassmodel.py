""" Now that the user can read in a file 
    this creates a model which uses the 
    price, class and gender
Author : AstroDave
...
for i in range(1, number_of_classes):
    for j in range(1, number_of_price_brackets):
...
# I predict they dont survive, and if >= 0.5 they do
...
predictions_file = open(filepath + '/genderclassmodel.csv', 'w+')
